...
export class SchedulerService {
  ...
  async handleAssetUpdatesAndNotifications() {
    ...
    try {
      ...
      this.logger.error(
        `Error during asset updates and notifications: ${message}`,
      );
    }
  }
  ...
  async handleWeeklyReports() {
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : String(error);
      this.logger.error(`Error during weekly reports: ${message}`);
    }
  }
  ...
  async handleMonthlyReports() {
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : String(error);
      this.logger.error(`Error during monthly reports: ${message}`);
    }
  }
  ...
  async handleQuarterlyReports() {
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : String(error);
      this.logger.error(`Error during quarterly reports: ${message}`);
    }
  }
  ...
  async handleYearlyReports() {
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : String(error);
      this.logger.error(`Error during yearly reports: ${message}`);
    }
  }
